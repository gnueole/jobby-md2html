...
const themeIcons = {
    system: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 18a6 6 0 0 0 0-12v12z" fill="currentColor"/></svg>`,
...
export function initThemeToggle(btnThemeToggle, themeBtnIcon, themeBtnText) {
    ...
    if (btnThemeToggle) {
        btnThemeToggle.addEventListener('click', () => {
            ...
            appTheme = nextTheme[appTheme] || 'system';
